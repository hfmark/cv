...
\Year{In review}  &
  ...
  \small\emph{Preprint available on ESSOAR:} \href{https://doi.org/10.22541/essoar.172434288.86649219/v1}{10.22541/essoar.172434288.86649219/v1} \\
\Year{In review}  &
  \Me, Zhu, J, \Masako, Aliod, D, \Maurice.
  shipgrav: A Python package for marine gravimetry.
  \small\emph{Submitted to JOSS; copies available upon request. Code available at} \url{https://github.com/PFPE/shipgrav}. \\
\Year{In prep}  &
...
\begin{EntriesTable}
  ...
  \\
  ~ & \textbf{Peer reviewer for:} JGR Solid Earth, Nature Geoscience, Geophysical Research Letters, Science Advances, Nature Communications, Journal of Open Source Software, Geoscience Letters, Earth and Planetary Science Letters, Seismological Research Letters, Geological Society of London Special Publications, Seismica, Tectonics, The Seismic Record
  \\
...
\begin{EntriesTable}
\Year{2024}  & \textbf{Texas A\&M University}, Oceanography Department seminar
  \\
