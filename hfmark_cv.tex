...
\newcommand{\AMNH}{American Museum of Natural History}
...
\newcommand{\Ari}{Cort\'{e}s-Rivas, V}
...
\newcommand{\Jonas}{Preine, J}
\newcommand{\EMor}{Moreno, E}
\newcommand{\MMye}{Myers, M}
\newcommand{\XYang}{Yang, X}
...
\Year{2026}  &
  ...
  Preprint \href{https://doi.org/10.22541/essoar.15002815/v1}{available on essoar}
\\
\Year{2026} &
  Wu, J-N, \Masako, \Me, Zhu, J, Fornari, D, \Maurice, Lanagan, T, Faluotico, S, Hayden, E, Small, M, Aliod, D, Brady, N, Metzger, A, PFPE.
  ...
  \DOI{10.1029/2025GC012621}
\\
\Year{2026} &
  \Masako, \Maurice, \Me, \WSage, \Jonas.
...
\begin{EntriesTable}
\Year{In prep} &
  \Me, \Jonas, \WSage, \Masako, \Maurice.
  Seismic evidence for Cenozoic volcanic activity in the Western Pacific.
\\
\Year{In prep} &
  \Jonas, \Me, \Masako, \Maurice, \WSage, Hübscher, C, Seidel, E, Hartge, M, Friedrich, A, Schebeck, L.
  Comparison of high-resolution marine seismic sources from academic offshore surveys.
\end{EntriesTable}
...
\begin{EntriesTable}
  \Duration{2025}{\Ongoing} & \textbf{Climate Lab}, \AMNH, Explainer (volunteer)
  \\
  \Year{2024--2026} & \textbf{Buzzards Bay Term}, \gull, Natural science faculty
  \\
  \Year{2023} &
  ...
  \\
  ~ & \textbf{Guest Lecturer for:} \textit{EESC 1006: What's New in Earth and Environmental Sciences}, \CU, 2026; \textit{ENVR 1200: Dynamic Earth}, Northeastern University, 2025; \textit{EPS 564: Multidisciplinary Study of Subduction Zones}, \WUSTL, 2020.
\end{EntriesTable}
...
\begin{EntriesTable}
  \Duration{2025}{\Ongoing} & \textbf{LDEO Campus Life Committee}, Department representative
  \\
  ...
  \\
  ~ & \textbf{Peer reviewer for:} JGR Solid Earth, Nature Geoscience, Geophysical Research Letters, Science Advances, Nature Communications, Journal of Open Source Software, Geoscience Letters, Earth and Planetary Science Letters, Seismological Research Letters, Geological Society of London Special Publications, Seismica, Tectonics, The Seismic Record, Canadian Journal of Earth Sciences, Geophysical Journal International, Geology
  \\
  ~ & \textbf{Conference sessions convened:} SAGE/GAGE Workshop 2024, \textit{Open data, open code, and open access: best practices and new opportunities in geophysics}; SSA Annual Meeting 2022, \textit{Marine Seismology}; AGU Fall Meeting 2021, \textit{EP15 -- Coupling of the Cryosphere, Solid Earth, Surface, and Climate in Shaping Late Cenozoic Topography}
\end{EntriesTable}
...
\begin{EntriesTable}
\Year{2026}  & \textbf{Lamont Doherty Earth Observatory}, MPG/SGT Department seminar
  \\
...
\begin{EntriesTable}
  \Year{2026} & R/V \textit{Thompson}, TN449. \newline
  \small Multi-scale magnetic survey in the western Pacific with AUV Sentry.
  \\
...
\begin{EntriesTable}
  \Duration{2023}{2025} & Essay reviewer for \href{https://www.sye-initiative.org}{Syrian Youth Empowerment Initiative}.
  \\
...
\Year{2025} &
    \Me, \danl, \Donna, \Ari, \behn.
    \textit{Seismic structure and estimated composition of arc crust in the Andreanof segment of the Aleutian Arc from wide-angle refraction data.}
    \AGU, New Orleans, LA. \\
~ &
    \Me, \Jonas, \Masako, \WSage, \Maurice, \EMor.
    \textit{Multiple generations of magmatic activity imaged by high-resolution seismic reflection data in the western Pacific.}
    \AGU, New Orleans, LA (poster). \\
~ & 
    Moss, M, \MMye, \Me, \XYang, Cheng, Y, Grapenthin, R, Lizik, Y, Portner, DE, Lee, WJD, Wu, S-M, Larsen, JF, Coombs, ML, Freymuller, JT.
    \textit{Petrologic and Geophysical Synthesis of the Magmatic System at Akutan Volcano.}
    \AGU, New Orleans, LA. \\
~ &
    \Me, \danl, \Donna, \Ari, \behn.
    \textit{Seismic Structure of the Andreanof Segment of the Aleutian Arc, and Implications for the Composition of Arc Crust.}
    Alaska-Aleutian Arc Workshop, Anchorage, AK. \\
\Year{2024} & 
    \Me.
